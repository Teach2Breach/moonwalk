...
**Note**: The SQLite database (`ntdll_signatures_v2.db`) is generated by a separate signature builder tool that will be released at a later date. This tool downloads clean DLLs from Microsoft symbol servers and extracts function signatures.
